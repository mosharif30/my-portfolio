  ...
  projects: [
    {
      ...
      description: "Scalable blog with categorized browsing, real‑time interaction, and secure auth. Focused on responsive UI and API performance.",
    ...
    },
    {
      ...
      description: "Responsive, SEO‑optimized portfolio with dynamic routing and component‑based design.",
